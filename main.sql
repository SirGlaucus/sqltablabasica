CREATE TABLE tablaproductos(nombre VARCHAR(25), id INT, fecha_creacion DATE, proveedor VARCHAR(255), categoria VARCHAR(35), probando VARCHAR(25), PRIMARY KEY (id));

CREATE TABLE tablaventas(fecha DATE, id_producto INT, cliente VARCHAR(25), metodo_pago VARCHAR(25), referencia INT, probandofkey VARCHAR(25), 
FOREIGN KEY (id_producto) REFERENCES tablaproductos(id), FOREIGN KEY (probandofkey) REFERENCES tablaproductos(probando))


CREATE TABLE tablaventas(fecha DATE, id_producto INT, cliente VARCHAR(25), metodo_pago VARCHAR(25), referencia INT, probando VARCHAR(25), 
FOREIGN KEY (id_producto) REFERENCES tablaproductos(id))
